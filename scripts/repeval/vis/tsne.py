"""Per-condition t-SNE on captured activations using `torchdr.TSNE`."""
...
DEFAULT_OUT_ROOT = REPO_ROOT / "predictions" / "repeval" / "vis" / "tsne"
...
def main(argv: list[str] | None = None) -> None:
    p = argparse.ArgumentParser(prog="python -m scripts.repeval.vis.tsne")
